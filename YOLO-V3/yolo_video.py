...
def displayVehicleCount(frame, total_vehicles, each_vehicle):
	cv2.putText(
		frame, #Image
	...
	cv2.putText(
		frame, #Image
		'Detected Types: ' + str(each_vehicle), #Label
		(20, 60), #Position
		cv2.FONT_HERSHEY_SIMPLEX, #Font
		0.5, #Size
		(0, 0xFF, 0), #Color
...
while True:
	...
	displayVehicleCount(frame, total_vehicles, each_vehicle)
	if writer is None:
